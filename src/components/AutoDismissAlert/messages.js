export default {
  ...
  editProfileSuccess: 'Sucessfully updated profile!',
  editProfileFailure: 'Failed to update profile. Please check the form and try again.',

  logWorkoutFailure: 'Failed to log workout. Please try again.'
}
